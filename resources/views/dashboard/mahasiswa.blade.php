                    ...
                    <tr>
                        ...
                        <td class="text-center text-light">
                            <div class="btn-group" style="height: 35px; width: 90px;">
                                <button class="bg-warning rounded-left text-light border-0">X</button>
                                <button class="bg-primary border-0"><i class="bi text-light bi-pencil-square"></i></button>
                                <button onclick="deleteMahasiswa('{{ route('mahasiswa.delete', ['id_akun' => $mahasiswa->id_akun]) }}')" class="bg-danger border-0 rounded-right"><i class="bi text-light bi-trash3"></i></button>
                            </div>
                        </td>
                    </tr>
                    @endforeach
