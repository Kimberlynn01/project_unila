            ...
            <div class="list-group">
                <div class="list-group-item list-group-item-action active">
                    Program Studi
                                    ...
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S2 Teknologi Pendidikan">S2 Teknologi Pendidikan</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S2 Pendidikan Matematika">S2 Pendidikan Matematika</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S2 Pendidikan Keguruan Guru SD">S2 Pendidikan Keguruan Guru SD</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S2 Pendidikan Fisika">S2 Pendidikan Fisika</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S2 Pendidikan Bahasa Lampung">S2 Pendidikan Bahasa Lampung</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S2 Pendidikan Bahasa Inggris">S2 Pendidikan Bahasa Inggris</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S2 Pend. IPS">S2 Pend. IPS</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S2 Pend. Guru SD">S2 Pend. Guru SD</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S2 Pend. Bahasa Indonesia">S2 Pend. Bahasa Indonesia</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S2 Manajemen Pendidikan">S2 Manajemen Pendidikan</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S2 Keguruan IPA">S2 Keguruan IPA</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S1 Pendidikan Teknologi Informasi">S1 Pendidikan Teknologi Informasi</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S1 Pendidikan Musik">S1 Pendidikan Musik</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S1 Pendidikan Bahasa Perancis">S1 Pendidikan Bahasa Perancis</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S1 Pend. Seni Tari">S1 Pend. Seni Tari</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S1 Pend. Sejarah">S1 Pend. Sejarah</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S1 Pend. Matematika">S1 Pend. Matematika</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S1 Pend. Kimia">S1 Pend. Kimia</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S1 Pend. Kewarganegaraan">S1 Pend. Kewarganegaraan</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S1 Pend. Jasmani & Kesehatan">S1 Pend. Jasmani & Kesehatan</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S1 Pend. Guru Sekolah Dasar">S1 Pend. Guru Sekolah Dasar</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S1 Pend. Guru PAUD">S1 Pend. Guru PAUD</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S1 Pend. Geografi">S1 Pend. Geografi</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S1 Pend. Fisika">S1 Pend. Fisika</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S1 Pend. Ekonomi">S1 Pend. Ekonomi</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S1 Pend. Biologi">S1 Pend. Biologi</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S1 Pend. Bahasa Inggris">S1 Pend. Bahasa Inggris</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S1 Pend. Bahasa Indonesia">S1 Pend. Bahasa Indonesia</a>
                                    <a href="#" class="list-group-item list-group-item-action list-prodi" data-id="S1 Bimbingan Konseling">S1 Bimbingan Konseling</a>
                            </div>
        </div>
    </div>
    <div class="col-md-8">
        <div class="card">
            <div class="card-header list-group-item list-group-item-action active">
                Data Dosen
                <div class="toolbar">
                    <button type="button" data-toggle="modal" id="btn-tambah-dosen" class="btn btn-light "><i class="fa fa-plus"></i> Tambah Data</button>
                </div>
            </div>
            <div class="card-body">
...
<script type="text/javascript">
    var BASE_URL = "https://egov.phicos.co.id/lampung/unila/back/";
